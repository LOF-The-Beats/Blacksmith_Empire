...
public:
	...
	void Print(const char* t, int x1, int y1, uint c, float scale = 1);
	void Clear( uint c );
	...
	void Copy_Region_To(Surface* dst, int src_X, int src_Y, int region_W, int region_H, int dst_X, int dst_Y, int scale);
	// attributes
	uint* pixels = 0;
